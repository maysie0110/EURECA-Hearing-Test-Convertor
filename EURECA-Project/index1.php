...
$fp=fopen('newleftcncwords.txt','w');
...
if ($result->num_rows > 0) {
   $string="";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        //with only right measure - CNC phenomes
        // if($rightmeasure)
        // {
        //     foreach($rightmeasure as $value)
        //     {
 ...
 /**************************************************************************** */       
        //with only right measure - CNC words
        // if($rightmeasure)
        // {
        //     foreach($rightmeasure as $value)
        //     {
        ...
        //             $cncphenomes=0;
        //         }
        //         $string.="{".$frequency.",".$decibels.",$cncwords},";
        //     }
        //     $string = substr($string, 0, -1);
        // }

/**************************************************************************** */   
        //with only left measure - CNC phenomes
...
/**************************************************************************** */   
        //with only left measure - CNC words
